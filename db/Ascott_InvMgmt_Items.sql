...
INSERT INTO `Items` (`name`, `category`, `picture`, `reorder_pt`, `out_by`, `in_by`, `in_out_ratio`) VALUES ('Nescafe Gold Blend Dcf', 'Guest Hamper', 'Nescafe Gold.jpg', 1, 'carton', 'carton', 1.0);
INSERT INTO `Items` (`name`, `category`, `picture`, `reorder_pt`, `out_by`, `in_by`, `in_out_ratio`) VALUES ('Raw Sugar', 'Guest Hamper', 'Raw Sugar.jpg', 1, 'packet', 'carton', 8.00);
INSERT INTO `Items` (`name`, `category`, `picture`, `reorder_pt`, `out_by`, `in_by`, `in_out_ratio`) VALUES ('White Sugar', 'Guest Hamper', 'White Sugar.jpg', 1, 'packet', 'carton', 8.00);
INSERT INTO `Items` (`name`, `category`, `picture`, `reorder_pt`, `out_by`, `in_by`, `in_out_ratio`) VALUES ('Coffee Creamer', 'Guest Hamper', 'Creamer.jpg', 1, 'carton', 'carton', 1.0);
...
INSERT INTO `Items` (`name`, `category`, `picture`, `reorder_pt`, `out_by`, `in_by`, `in_out_ratio`) VALUES ('Parmesan Crackers', 'Guest Hamper', 'Cheese Crackers.jpg', 1, 'kg', 'kg', 1.0);
INSERT INTO `Items` (`name`, `category`, `picture`, `reorder_pt`, `out_by`, `in_by`, `in_out_ratio`) VALUES ('Sea Salt Chocolate Cookies', 'Guest Hamper', 'Sea Salt Chocolate Cookies.jpg', 1, 'pc', 'pc', 1.0);
